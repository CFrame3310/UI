...
closeButton.MouseButton1Click:Connect(function()
    ...
    TweenService:Create(closeButton, TweenInfo.new(.125, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {Position = Closed and UDim2.new(0.954, 2, 0.235, 0) or UDim2.new(0.954, 3, 0.235, 0)}):Play()
    if not Closed then
        wait(.125)
...
TweenService:Create(toggleOuterUIStroke, TweenInfo.new(.125, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {Color = bool and Color3.fromRGB(0,255,0) or Color3.fromRGB(255,0,0)}):Play()
